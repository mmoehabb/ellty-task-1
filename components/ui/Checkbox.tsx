...
export function Checkbox(props: Props) {
  ...
  return (
    <div className="flex items-center justify-between w-full h-[42px] px-2">
      <span className="text-md font-normal text-black">{props.label}</span>

      <button
        className={cn(
          "w-[23px] h-[23px] p-1 border rounded-md cursor-pointer ",
          {
            "bg-blue-100 outline-[3px] outline-blue-10 border-1":
              pressing && !selected,
            "bg-blue-100 outline-[3px] outline-blue-10 border-0":
              pressing && selected,
